...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Conversion du prix
    df["Price_Euros"] = (df["Price"] * 0.009292 * 100000).round(2)
    ...
    cols_to_drop = ["Name", "Price", "Engine", "Seats", "New_Price"]
...
def create_preprocessing_pipeline(df: pd.DataFrame) -> Pipeline:
    """Créer un pipeline sklearn pour prétraitement"""
    numeric_features = ["Year", "Kilometers_Driven", "Mileage", "Power", "Price_Euros"]
...
# Préparer un CSV "prediction" sans la colonne cible Price_Euros
